---
title: cratetitlelcJetpackJumpDaily (lc_JetpackJump_Daily)
category: crate
---

# cratetitlelcJetpackJumpDaily (lc_JetpackJump_Daily)
...
This crate expires after 1d. The contents are decided by 4 draws from 3 different pools.
  * 1 draw from pool "lcpool_JetpackJumpTrooper_DailyCrate"
  * 2 draws from pool "lcpool_currency_t1"
  * 1 draw from pool "lcpool_smpl_t1"

## Pool "lcpool_JetpackJumpTrooper_DailyCrate" (x1 draw)
