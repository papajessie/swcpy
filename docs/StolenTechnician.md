...
# Stolen Repair Droid (StolenTechnician) — version 1092
...
These stats internal to the system link different parts of data together.
  ...
  * _Not found: Ability, Death attack apply buffs, Death projectile, Hero data, Secondary attack apply buffs, Secondary attack projectile type, Secondary attack self buff, Spawn apply buffs, Upgrade shard uid_
