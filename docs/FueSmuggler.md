...
|Damage per shot             |50  |50    |434  |
|Shot count                  |3   |2     |3    |
|Time between two clips      |2s  |1.500s|2s   |
|Salvos per clip             |3   |2     |3    |
...
|Salvos per clip              |3     |2     |3     |
|Clips period                 |3.250s|2.250s|3.250s|
|Salvos per gun sequence      |2     |2     |1     |
|Cannons shot per gun sequence|2     |2     |1     |
...
|Heavy vehicular hero|20% |20% |100%|
|Infantry hero       |20% |20% |100%|
|Vehicle hero        |20% |20% |100%|
|Infantry            |20% |20% |100%|
