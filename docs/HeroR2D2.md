...
These stats internal to the system link different parts of data together.
  ...
  * Unit ID: HeroR2D2
  * _Not found: Ability, Death attack apply buffs, Death projectile, Secondary attack apply buffs, Secondary attack projectile type, Secondary attack self buff, Spawn apply buffs, Upgrade shard uid_
