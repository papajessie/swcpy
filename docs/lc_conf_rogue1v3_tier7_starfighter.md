...
# Crate Obsidian Conflict Crate (lc_conf_rogue1v3_tier7_starfighter)
...
### Rebellion, with HQ level 6
    ...
    * (1/2) 5x shrd_specialAttackAtmosMig
    * (1/2) 5x shrd_specialAttackFangFighter
...
### Rebellion, with HQ level 6
    ...
    * (1/4) 8x specialAttackAtmosMig1
    * (1/4) 8x specialAttackFangFighter1
