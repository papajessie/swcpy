---
title: cratetitlelcconf5thAnniversarywk2tier7 (lc_conf_5thAnniversary_wk2_tier7)
category: crate
---

# cratetitlelcconf5thAnniversarywk2tier7 (lc_conf_5thAnniversary_wk2_tier7)

Crates are given as rewards for various actions. The content is revealed only when opening them, by drawing once (or more) in various prize pools. Only one prize is won for each pool per draw. The in-game description of expectations is written manually and can be wrong. The probability of obtaining one prize is indicated below; the pools change according to planet, faction and HQ level.

This crate expires after 7d. The contents are one draw from each of the 3 pools.

## Pool "lcpool_conf_5thAnniversary_wk2_tier7" (x1 draw)

### Empire for HQ levels 7-11

  * (1/1) 24 data fragments of equipment [Reinforced Cantina Bracing](eqpEmpireCantinaHealth)
...
### Rebellion for HQ levels 7-11
  ...
  * (1/1) 24 data fragments of equipment [Reinforced Cantina Bracing](eqpRebelCantinaHealth)
