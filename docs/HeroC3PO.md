...
These stats internal to the system link different parts of data together.
  ...
  * Unit ID: HeroC3PO
  * _Not found: Ability, Apply buffs, Death attack apply buffs, Death projectile, Secondary attack apply buffs, Secondary attack projectile type, Secondary attack self buff, Spawn apply buffs, Upgrade shard uid_
