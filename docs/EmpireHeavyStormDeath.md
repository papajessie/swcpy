...
# Heavy Undead Trooper (EmpireHeavyStormDeath) — version 1092
...
#### Modifier "Reduce heals"
  ...
  * Reduce heals uid: buffReduceHeals2
...
I could not show the following roles, because I was not programmed to : buffReduceHealsc, buffReduceHealsbasic
