...
# Twi'lek Incinerator (EmpireTwilekIncinerator) — version 1092
...
#### Modifier "Reduce heals"
  ...
  * Reduce heals uid: buffReduceHeals1
  * Reduce heals value: 25
  * _Not found: Reduce heals mults_
...
#### Modifier "Defend splash"
  ...
  * Defend splash uid: buffDefendSplash2
  * Defend splash value: -30
  * _Not found: Defend splash mults_
...
These stats internal to the system link different parts of data together.
  ...
  * _Not found: Ability, Hero data, Secondary attack apply buffs, Secondary attack projectile type, Secondary attack self buff, Upgrade shard uid_
...
I could not show the following roles, because I was not programmed to : buffDefendSplashc, buffDefendSplashbasic, buffReduceHealsc, buffReduceHealsbasic
