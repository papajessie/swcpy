...
# trp_title_PhantomNavalStrike (no text translation) (PhantomNavalStrike) — version 1090
...
### Unit stats
  ...
  * Unit capacity: 1
  * Type: phantom
  * _Not found: Shield asset name, Shield cooldown, Shield health, Shield range, Unlock planet_
...
### Targeting
  ...
  * Target preferences: **Storage (100)**, **Turret (100)**, **Ressource generator (100)**, Shield (50), Shield generator (50), Other building (25), Headquarters (25), Heavy vehicle (1), Light vehicle (1), Heavy infantry (1), Heavy vehicule hero (1), Flying infantry (1), Infantry (1), Heavy infantry hero (1), Flying vehicle (1), Support troop (1), Infantry hero (1), Vehicule hero (1), Droideka (1), Wall (0), Trap (0)
  * View range: 4
...
These stats internal to the system link different parts of data together.
  ...
  * _Not found: Ability, Death projectile, Death projectile damage, Death projectile delay, Death projectile distance, Hero data, Self buff, Upgrade shard uid_
