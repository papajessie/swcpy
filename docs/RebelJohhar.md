...
|DPS  |277.207|289.528|301.848|314.168|326.489|350.924|377.207|405.544|435.934|468.583|
  ...
  * Max speed: 58
  * Secondary attack damage multipliers: **(100%)**: Droideka, Heavy infantry hero, Heavy vehicle, Infantry hero, Light vehicle, Trap, **(95%)**: Heavy infantry, **(85%)**: Wall, **(75%)**: Flying infantry, Flying vehicle, Heavy vehicule hero, Other building, Vehicule hero, **(55%)**: Turret, **(50%)**: Headquarters, Ressource generator, Shield generator, Storage, **(45%)**: Infantry, **(30%)**: Support troop, **(25%)**: Shield
