...
|Level |5    |4    |1    |2    |3    |
|------|-----|-----|-----|-----|-----|
|Health|22080|21240|19200|19800|20480|
...
|Level        |5                                     |4                                     |1                                       |2                                     |3                                     |
|-------------|--------------------------------------|--------------------------------------|----------------------------------------|--------------------------------------|--------------------------------------|
|Training time|10m13s                                |8m57s                                 |5m45s                                   |6m43s                                 |7m47s                                 |
|Training cost|175 Con.                              |145 Con.                              |50 Con.                                 |85 Con.                               |115 Con.                              |
|Building     |[Research Lab 3](rebelOffenseLab.html)|[Research Lab 3](rebelOffenseLab.html)|[Cantina 1](rebelContrabandCantina.html)|[Research Lab 2](rebelOffenseLab.html)|[Research Lab 3](rebelOffenseLab.html)|
...
|Level               |5                 |4                 |1                |2                |3                |
|--------------------|------------------|------------------|-----------------|-----------------|-----------------|
|Upgrade requirements|135 data fragments|105 data fragments|30 data fragments|45 data fragments|75 data fragments|
...
|Level          |5  |4  |1  |2  |3  |
|---------------|---|---|---|---|---|
|Damage per shot|602|553|406|455|504|
...
|Level                       |5       |4       |1      |2  |3      |
|----------------------------|--------|--------|-------|---|-------|
|Calculated damage per second|1157.692|1063.462|780.769|875|969.231|
...
|Level                            |5                     |4                     |1                     |2                     |3                     |
|---------------------------------|----------------------|----------------------|----------------------|----------------------|----------------------|
|Ability                          |abilityBigMouthAlien5 |abilityBigMouthAlien4 |abilityBigMouthAlien1 |abilityBigMouthAlien2 |abilityBigMouthAlien3 |
|Secondary attack projectile type |projectileMercGrenade5|projectileMercGrenade4|projectileMercGrenade1|projectileMercGrenade2|projectileMercGrenade3|
|Secondary attack shot apply buffs|buffDefenseReduction5 |buffDefenseReduction4 |buffDefenseReduction1 |buffDefenseReduction2 |buffDefenseReduction3 |
...
|Level|5     |4     |1     |2     |3     |
|-----|------|------|------|------|------|
|Order|215605|215604|215601|215602|215603|
