...
# Drabatan Saboteur (BigMouthAlien) — version 1098
...
|Level |4    |3    |5    |1    |2    |
|------|-----|-----|-----|-----|-----|
|Health|21240|20480|22080|19200|19800|
...
|Level        |4                                     |3                                     |5                                     |1                                       |2                                     |
|-------------|--------------------------------------|--------------------------------------|--------------------------------------|----------------------------------------|--------------------------------------|
|Training time|8m57s                                 |7m47s                                 |10m13s                                |5m45s                                   |6m43s                                 |
|Training cost|145 Con.                              |115 Con.                              |175 Con.                              |50 Con.                                 |85 Con.                               |
|Building     |[Research Lab 3](rebelOffenseLab.html)|[Research Lab 3](rebelOffenseLab.html)|[Research Lab 3](rebelOffenseLab.html)|[Cantina 1](rebelContrabandCantina.html)|[Research Lab 2](rebelOffenseLab.html)|
...
|Level               |4                 |3                |5                 |1                |2                |
|--------------------|------------------|-----------------|------------------|-----------------|-----------------|
|Upgrade requirements|105 data fragments|75 data fragments|135 data fragments|30 data fragments|45 data fragments|
...
|Level          |4  |3  |5  |1  |2  |
|---------------|---|---|---|---|---|
|Damage per shot|553|504|602|406|455|
...
|Level                       |4       |3      |5       |1      |2  |
|----------------------------|--------|-------|--------|-------|---|
|Calculated damage per second|1063.462|969.231|1157.692|780.769|875|
...
|Level                            |4                     |3                     |5                     |1                     |2                     |
|---------------------------------|----------------------|----------------------|----------------------|----------------------|----------------------|
|Ability                          |abilityBigMouthAlien4 |abilityBigMouthAlien3 |abilityBigMouthAlien5 |abilityBigMouthAlien1 |abilityBigMouthAlien2 |
|Secondary attack projectile type |projectileMercGrenade4|projectileMercGrenade3|projectileMercGrenade5|projectileMercGrenade1|projectileMercGrenade2|
|Secondary attack shot apply buffs|buffDefenseReduction4 |buffDefenseReduction3 |buffDefenseReduction5 |buffDefenseReduction1 |buffDefenseReduction2 |
...
|Level|4     |3     |5     |1     |2     |
|-----|------|------|------|------|------|
|Order|215604|215603|215605|215601|215602|
