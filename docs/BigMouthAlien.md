...
|Level |5    |3    |4    |1    |2    |
|------|-----|-----|-----|-----|-----|
|Health|22080|20480|21240|19200|19800|
...
|Level        |5                                     |3                                     |4                                     |1                                       |2                                     |
|-------------|--------------------------------------|--------------------------------------|--------------------------------------|----------------------------------------|--------------------------------------|
|Training time|10m13s                                |7m47s                                 |8m57s                                 |5m45s                                   |6m43s                                 |
|Training cost|175 Con.                              |115 Con.                              |145 Con.                              |50 Con.                                 |85 Con.                               |
...
|Level               |5                 |3                |4                 |1                |2                |
|--------------------|------------------|-----------------|------------------|-----------------|-----------------|
|Upgrade requirements|135 data fragments|75 data fragments|105 data fragments|30 data fragments|45 data fragments|
...
|Level          |5  |3  |4  |1  |2  |
|---------------|---|---|---|---|---|
|Damage per shot|602|504|553|406|455|
...
|Level                       |5       |3      |4       |1      |2  |
|----------------------------|--------|-------|--------|-------|---|
|Calculated damage per second|1157.692|969.231|1063.462|780.769|875|
...
|Level                            |5                     |3                     |4                     |1                     |2                     |
|---------------------------------|----------------------|----------------------|----------------------|----------------------|----------------------|
|Ability                          |abilityBigMouthAlien5 |abilityBigMouthAlien3 |abilityBigMouthAlien4 |abilityBigMouthAlien1 |abilityBigMouthAlien2 |
|Secondary attack projectile type |projectileMercGrenade5|projectileMercGrenade3|projectileMercGrenade4|projectileMercGrenade1|projectileMercGrenade2|
|Secondary attack shot apply buffs|buffDefenseReduction5 |buffDefenseReduction3 |buffDefenseReduction4 |buffDefenseReduction1 |buffDefenseReduction2 |
...
|Level|5     |3     |4     |1     |2     |
|-----|------|------|------|------|------|
|Order|215605|215603|215604|215601|215602|
