...
|Level |1    |5    |3    |4    |2    |
|------|-----|-----|-----|-----|-----|
|Health|19200|22080|20480|21240|19800|
...
|Level        |1                                        |5                                      |3                                      |4                                      |2                                      |
|-------------|-----------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|
|Training time|5m45s                                    |10m13s                                 |7m47s                                  |8m57s                                  |6m43s                                  |
|Training cost|50 Con.                                  |175 Con.                               |115 Con.                               |145 Con.                               |85 Con.                                |
|Building     |[Cantina 1](empireContrabandCantina.html)|[Research Lab 3](empireOffenseLab.html)|[Research Lab 3](empireOffenseLab.html)|[Research Lab 3](empireOffenseLab.html)|[Research Lab 2](empireOffenseLab.html)|
...
|Level               |1                |5                 |3                |4                 |2                |
|--------------------|-----------------|------------------|-----------------|------------------|-----------------|
|Upgrade requirements|30 data fragments|135 data fragments|75 data fragments|105 data fragments|45 data fragments|
...
|Level          |1  |5  |3  |4  |2  |
|---------------|---|---|---|---|---|
|Damage per shot|345|508|428|468|388|
...
|Level                       |1      |5       |3      |4       |2      |
|----------------------------|-------|--------|-------|--------|-------|
|Calculated damage per second|784.091|1154.545|972.727|1063.636|881.818|
...
|Level                            |1                     |5                     |3                     |4                     |2                     |
|---------------------------------|----------------------|----------------------|----------------------|----------------------|----------------------|
|Ability                          |abilitySecurityDroid1 |abilitySecurityDroid5 |abilitySecurityDroid3 |abilitySecurityDroid4 |abilitySecurityDroid2 |
|Secondary attack projectile type |projectileMercGrenade1|projectileMercGrenade5|projectileMercGrenade3|projectileMercGrenade4|projectileMercGrenade2|
|Secondary attack shot apply buffs|buffDefenseReduction1 |buffDefenseReduction5 |buffDefenseReduction3 |buffDefenseReduction4 |buffDefenseReduction2 |
...
|Level|1     |5     |3     |4     |2     |
|-----|------|------|------|------|------|
|Order|115601|115605|115603|115604|115602|
