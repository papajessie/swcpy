...
|Level |4    |2    |3    |5    |1    |
|------|-----|-----|-----|-----|-----|
|Health|21240|19800|20480|22080|19200|
...
|Level        |4                                      |2                                      |3                                      |5                                      |1                                        |
|-------------|---------------------------------------|---------------------------------------|---------------------------------------|---------------------------------------|-----------------------------------------|
|Training time|8m57s                                  |6m43s                                  |7m47s                                  |10m13s                                 |5m45s                                    |
|Training cost|145 Con.                               |85 Con.                                |115 Con.                               |175 Con.                               |50 Con.                                  |
|Building     |[Research Lab 3](empireOffenseLab.html)|[Research Lab 2](empireOffenseLab.html)|[Research Lab 3](empireOffenseLab.html)|[Research Lab 3](empireOffenseLab.html)|[Cantina 1](empireContrabandCantina.html)|
...
|Level               |4                 |2                |3                |5                 |1                |
|--------------------|------------------|-----------------|-----------------|------------------|-----------------|
|Upgrade requirements|105 data fragments|45 data fragments|75 data fragments|135 data fragments|30 data fragments|
...
|Level          |4  |2  |3  |5  |1  |
|---------------|---|---|---|---|---|
|Damage per shot|468|388|428|508|345|
...
|Level                       |4       |2      |3      |5       |1      |
|----------------------------|--------|-------|-------|--------|-------|
|Calculated damage per second|1063.636|881.818|972.727|1154.545|784.091|
...
|Level                            |4                     |2                     |3                     |5                     |1                     |
|---------------------------------|----------------------|----------------------|----------------------|----------------------|----------------------|
|Ability                          |abilitySecurityDroid4 |abilitySecurityDroid2 |abilitySecurityDroid3 |abilitySecurityDroid5 |abilitySecurityDroid1 |
|Secondary attack projectile type |projectileMercGrenade4|projectileMercGrenade2|projectileMercGrenade3|projectileMercGrenade5|projectileMercGrenade1|
|Secondary attack shot apply buffs|buffDefenseReduction4 |buffDefenseReduction2 |buffDefenseReduction3 |buffDefenseReduction5 |buffDefenseReduction1 |
...
|Level|4     |2     |3     |5     |1     |
|-----|------|------|------|------|------|
|Order|115604|115602|115603|115605|115601|
