...
|Level |3    |5    |2    |1    |4    |
|------|-----|-----|-----|-----|-----|
|Health|20480|22080|19800|19200|21240|
...
|Level        |3                                      |5                                      |2                                      |1                                        |4                                      |
|-------------|---------------------------------------|---------------------------------------|---------------------------------------|-----------------------------------------|---------------------------------------|
|Training time|7m47s                                  |10m13s                                 |6m43s                                  |5m45s                                    |8m57s                                  |
|Training cost|115 Con.                               |175 Con.                               |85 Con.                                |50 Con.                                  |145 Con.                               |
|Building     |[Research Lab 3](empireOffenseLab.html)|[Research Lab 3](empireOffenseLab.html)|[Research Lab 2](empireOffenseLab.html)|[Cantina 1](empireContrabandCantina.html)|[Research Lab 3](empireOffenseLab.html)|
...
|Level               |3                |5                 |2                |1                |4                 |
|--------------------|-----------------|------------------|-----------------|-----------------|------------------|
|Upgrade requirements|75 data fragments|135 data fragments|45 data fragments|30 data fragments|105 data fragments|
...
|Level          |3  |5  |2  |1  |4  |
|---------------|---|---|---|---|---|
|Damage per shot|428|508|388|345|468|
...
|Level                       |3      |5       |2      |1      |4       |
|----------------------------|-------|--------|-------|-------|--------|
|Calculated damage per second|972.727|1154.545|881.818|784.091|1063.636|
...
|Level                            |3                     |5                     |2                     |1                     |4                     |
|---------------------------------|----------------------|----------------------|----------------------|----------------------|----------------------|
|Ability                          |abilitySecurityDroid3 |abilitySecurityDroid5 |abilitySecurityDroid2 |abilitySecurityDroid1 |abilitySecurityDroid4 |
|Secondary attack projectile type |projectileMercGrenade3|projectileMercGrenade5|projectileMercGrenade2|projectileMercGrenade1|projectileMercGrenade4|
|Secondary attack shot apply buffs|buffDefenseReduction3 |buffDefenseReduction5 |buffDefenseReduction2 |buffDefenseReduction1 |buffDefenseReduction4 |
...
|Level|3     |5     |2     |1     |4     |
|-----|------|------|------|------|------|
|Order|115603|115605|115602|115601|115604|
