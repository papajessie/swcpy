---
title: cratetitlelcconflicthalfskinatier820180920comp (lc_conflict_halfskin_a_tier8_20180920_comp)
category: crate
---

# cratetitlelcconflicthalfskinatier820180920comp (lc_conflict_halfskin_a_tier8_20180920_comp)

Crates are given as rewards for various actions. The content is revealed only when opening them, by drawing once (or more) in various prize pools. Only one prize is won for each pool per draw. The in-game description of expectations is written manually and can be wrong. The probability of obtaining one prize is indicated below; the pools change according to planet, faction and HQ level.

This crate expires after 14d. The contents are one draw from each of the 4 pools.
...
### Empire for HQ level 5
  ...
  * (1/1) 20 troop sample [Enhanced AT-ST Walker](EmpireATSTHalfSkinSample)
...
### Rebellion for HQ level 5
  ...
  * (1/1) 20 troop sample [Enhanced T2-B Repulsor Tank](RebelT2BTankHalfSkinSample)
