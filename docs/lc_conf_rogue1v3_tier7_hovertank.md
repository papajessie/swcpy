...
# Crate Obsidian Conflict Crate (lc_conf_rogue1v3_tier7_hovertank)
...
### Rebellion, with HQ level 6
    ...
    * (1/4) 8x troopRebelHovertankSample1
    * (1/4) 8x troopEmpireHovertankSample1
...
### Rebellion, with HQ level 6
    ...
    * (1/2) 5x eqpEmpireHovertank
    * (1/2) 5x eqpRebelHovertank
