...
# trp_title_PhantomMilleniumFalcon (no text translation) (PhantomMilleniumFalcon) — version 1092
...
### Unit stats
  ...
  * Unit capacity: 1
  * Type: phantom
  * _Not found: Name, Shield cooldown, Shield health, Shield range, Unlock planet_
...
#### Modifier "Invulnerable"
  ...
  * Invulnerable uid: buffInvulnerable1
  * Invulnerable value: 0
  * _Not found: Invulnerable mults_
...
These stats internal to the system link different parts of data together.
  ...
  * _Not found: Ability, Death attack apply buffs, Death projectile, Hero data, Secondary attack apply buffs, Secondary attack projectile type, Secondary attack self buff, Upgrade shard uid_
...
I could not show the following roles, because I was not programmed to : buffInvulnerablebasic, buffInvulnerablec
